...
function Remove-WinoldWP {
    ...
    $RegEx = '"([^"]+)"\.';
    $Activity = "$_Path removal progress - Press Ctrl+C if you want to stop and continue"
    ...
    Write-Output "Operation completed. $Counter items have been removed."
}

Export-ModuleMember -Function Remove-WinoldWP