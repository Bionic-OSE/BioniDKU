Write-Host -ForegroundColor Cyan -BackgroundColor DarkGray "Replacing Segoe UI Emoji Font with the one from Windows 11 build 22563" -n; Write-Host ([char]0xA0)
